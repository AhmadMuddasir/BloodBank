...
//the patient should be either donor or receiver
    ...
    mapping(uint256 => bool) isAadharRegistered;
    ...
    function newPatient(
        ...
        // is owner or not
        require(
            !isAadharRegistered[_aadhar],
            "Addhar number is already registered"
        );
        ...
        isAadharRegistered[_aadhar] = true;
    ...
    function getPatientRecord(
        ...
        require(PatientRecord[index].aadhar == _aadhar,"Wrong aadhar Number");
    ...
    function bloodTransaction(
        ...
        require(
            _from != _to,
            "donor and receiver cannot be same in blood transaction"
        );
    ...
    function getParticularBloodTransaction(
        uint256 _aadhar
    ) external view returns (BloodTransaction[] memory) {
        uint256 index = PatientRecordIndex[_aadhar];
        return PatientRecord[index].bT;
    }
}
